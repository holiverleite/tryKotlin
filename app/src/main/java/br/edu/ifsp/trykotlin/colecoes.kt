...
fun main(){
    ...
    familia = listOf<String>("Haroldo", "Mãe", "Pai", "Heitor")
    ...
    val familyMap : MutableMap<String, String> = mutableMapOf( Pair("Pai", "Benedito"), Pair("Mãe", "Carmem") )
    familyMap.put("Filho", "Haroldo")
